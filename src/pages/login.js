            ...
            <form className="space-y-4 md:space-y-6" action="#">
              <div>
                ...
                <input
                  ...
                  name="username"
                  id="username"
                  className="bg-white border border-gray-200 text-gray-200 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5"
              ...
              <button
                ...
                type="submit"
                className="w-full text-black bg-green-100 enabled:hover:bg-white enabled:hover:text-green-100 enabled:hover:border enabled:hover:border-green-100 font-medium rounded-lg text-sm px-5 py-2.5 text-center disabled:opacity-25"
                onClick={onSubmit}
              >
                Sign in
              </button>
